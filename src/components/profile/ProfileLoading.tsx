    ...
    return (
      <div className="min-h-screen bg-blue-50 dark:bg-gray-900">
        <div className="container max-w-6xl px-4 py-8 mx-auto">
          {/* Header Skeleton */}
          <div className="mb-8">
            <div className="w-48 h-8 mb-2 bg-gray-300 rounded animate-pulse dark:bg-gray-900"></div>
            <div className="w-64 h-4 bg-gray-200 rounded animate-pulse dark:bg-gray-800"></div>
          </div>
          ...
          <div className="flex p-1 mb-6 space-x-1 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-[#1e1f20] dark:border-slate-700">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-24 h-10 bg-gray-200 rounded-md animate-pulse dark:bg-gray-800"></div>
            ))}
          </div>
          ...
          <div className="p-6 bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
            <div className="flex flex-col gap-6 md:flex-row">
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="w-32 h-32 bg-gray-300 rounded-full animate-pulse dark:bg-gray-800"></div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="space-y-2">
                      <div className="w-24 h-4 bg-gray-200 rounded animate-pulse dark:bg-gray-800"></div>
